...
if __name__ == "__main__":
    ...
    parser.add_argument("-image_folder", default='C:/Users/facua/Desktop/Scripts/images/', help="Path to folder containing image chips (ie 'Image_Chips/' ")
    parser.add_argument("-json_filepath", default = 'C:/Users/facua/Desktop/Boeing/xView_train.geojson', help="Filepath to GEOJSON coordinate file")
